...
async function getData(city) {
  ...
  if (data.cod == "404") {
    ...
    weatherImage.innerHTML = `  <img src="https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png"  alt="" height="150px" />
    ...
    maincontainerthree.style.display = "flex";
    maincontainerthree.style.flexDirection = "column";
    maincontainerthree.style.justifyContent = "space-between";
    ...
    maincontainerfour.style.display = "flex";
    maincontainerfour.style.flexDirection = "column";
    maincontainerfour.style.justifyContent = "space-between";
    ...
    maincontainerfive.style.display = "flex";
    maincontainerfive.style.flexDirection = "column";
    maincontainerfive.style.justifyContent = "space-between";
